    ...
    public class ArimaPredictor {
         ...
         */
        private static Prediction predict(Thoth thoth, Fund fund) {
        ...
        private static float getFeedbackMultiplier(Thoth thoth) {
            // On n'utilise pas le score de confiance du joueur car en sortie différente, ici on atténue
            ...
            return 1.0f + 0.35f * rawScore;
        }

        public float _computeConfidence(Thoth thoth, Fund fund) {
        ...
        public static Prediction recommend(Thoth thoth) {
            ...
            for (Fund f : thoth.funds) {
                ...
                thoth.AI.setRecommendationForFund(f, pred);
                ...
                if (pred.confidence > 0.2 && score > bestScore && pred.expectedReturn > 0 && enoughCapital) {
                    best = pred;
                    bestScore = score;
                }
            }
        ...
        public static Prediction recommend(Thoth thoth, Fund fund) {
            return predict(thoth, fund);
        }
        ...
        public static String explain(Prediction pred, ForecastResult r, double last) {
            ...
            return String.format("""
                <span style='color:#FF8C00;'>Decision Factors over time:</span>
                1. <b>Momentum</b> %.0f%% | 2. <b>Noise</b> %.0f%% | 3. <b>Trend</b> %.1f%%/m
        ...
        public static String why() {
            return """
                ...
                Thoth reads at most the last <b>80 months</b> of all funds' <i>waves</i>. It identifies <b>3 key components</b>:
                ...
                It is a <i>mathematical</i> model which provides <b>confidence value as wave precision</b>.
                <span style='font-size:90%;color:#888;margin-top:4px;margin-bottom:4px;'>
                <b style='color:#00ff00'>High confidence</b> (better) means <i>narrower prediction intervals</i> with less than 25% uncertainty.
                <b style='color:#FFA500'>Medium confidence</b> means 25-50% uncertainty, and <b style='color:#FF0000'>low confidence</b> means more than 50% uncertainty.
                Thoth may abstain from recommending if it has low confidence (more than 80% of uncertainty),
                if your capital is insufficient, if no stable trend is detected (too noisy), if expected return is not positive,
                or if you do not find Thoth AI helpful.</span>""";
        }
